...
4. **Performance Telemetry:** A built-in metrics panel that tracks exact retrieval latency in seconds and exposes the underlying "expanded bag of keywords" generated by the Groq HyDE model in real-time.
